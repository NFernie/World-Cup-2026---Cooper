-- Mark teams eliminated as soon as they cannot finish top two (Wooden Spoon leaderboard).
-- People's Champion already updates via mid-group clinch (6+ pts) and complete-group R32 flags.
...
begin
  ...
  -- Mid-group mathematical elimination (mirrors frontend hasClinchedTopTwo inverse).
  for g_letter in
