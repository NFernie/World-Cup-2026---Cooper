-- Odds leaderboard draws: each team earns half of their pre-match win odds.
  ...
  loop
    ...
    if v_draw then
      ...
      select
        ...
        r.match_id,
        case
          when pm.assigned_team_id = r.home_team_id then r.home_win_decimal / 2
          else r.away_win_decimal / 2
        end,
        case
          when pm.assigned_team_id = r.home_team_id then r.home_win_decimal
          else r.away_win_decimal
        end
