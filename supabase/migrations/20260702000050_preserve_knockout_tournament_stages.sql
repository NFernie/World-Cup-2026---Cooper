-- Preserve round_of_16+ stages on overall leaderboard; re-apply knockout advancement after group recalc.
...
begin
  ...
  -- Promote winners to round_of_16 / quarter_final / etc. from finished knockout matches.
